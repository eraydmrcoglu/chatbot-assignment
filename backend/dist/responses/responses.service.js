...
let ResponsesService = class ResponsesService {
    ...
    async saveResponses(userId, answers, currentQuestionIndex) {
        const sessionEndTime = currentQuestionIndex === 10 ? new Date() : null;
        return this.responseModel
            .findOneAndUpdate({ userId }, { answers, currentQuestionIndex, sessionEnd: sessionEndTime }, { new: true, upsert: true })
            .exec();
    }
    async findAll() {
